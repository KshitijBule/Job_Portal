        ...
        <div className="flex justify-between">
            <div className="flex gap-2 items-center">
              ...
              <div>
                ...
                <div className="text-lg text-mine-shaft-300">Google &#x2022; 3 days ago &#x2022; 68 applicants</div>
              </div>
            </div>
        ...
        <div className="flex justify-between">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {
                skills.map((item,index)=><ActionIcon key={index} color="brightSun.4" className="!h-fit !text-sm !font-medium !w-fit" variant="light" p="xs" radius="xl" aria-label="Settings">{item}
            </ActionIcon>)
              }
